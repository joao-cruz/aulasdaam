...
function Controller() {
    ...
    var exports = {};
    var __defers = {};
    $.__views.shareDestWindow = Ti.UI.createWindow({
    ...
    closeShareDest ? $.__views.__alloyId10.addEventListener("click", closeShareDest) : __defers["$.__views.__alloyId10!click!closeShareDest"] = true;
    $.__views.shareDestWindow.leftNavButton = $.__views.__alloyId10;
    $.__views.destinationName = Ti.UI.createLabel({
        top: "2",
        id: "destinationName",
        text: ""
    });
    $.__views.shareDestWindow.add($.__views.destinationName);
    ...
    $.__views.shareDestWindow.add($.__views.destinationImage);
    ...
    $.__views.shareDestWindow.add($.__views.destinationShareText);
    $.__views.shareBtn = Ti.UI.createButton({
        id: "shareBtn",
        title: "Share",
        bottom: "20"
    });
    $.__views.shareDestWindow.add($.__views.shareBtn);
    ...
    $.__views.shareDestNWindow = Ti.UI.iOS.createNavigationWindow({
        window: $.__views.shareDestWindow,
        id: "shareDestNWindow"
    });
    ...
    __defers["$.__views.__alloyId10!click!closeShareDest"] && $.__views.__alloyId10.addEventListener("click", closeShareDest);
