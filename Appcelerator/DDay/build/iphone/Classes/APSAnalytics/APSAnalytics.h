 ...
 * to send analytic data that can be viewed on the DreamDestinationADay Dashboard.
 *
 * For information on getting started with DreamDestinationADay Platform Services,
