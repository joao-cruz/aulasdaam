...
// in simulator we redefine to format for DreamDestinationADay Developer console
...
{\
	NSString * exceptionName = [@"org.dreamdestinationaday." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.dreamdestinationaday";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIDreamDestinationADayNativeItemNone = -1, 
	UIDreamDestinationADayNativeItemSpinner = -2,
	UIDreamDestinationADayNativeItemProgressBar = -3,
	
	UIDreamDestinationADayNativeItemSlider = -4,
	UIDreamDestinationADayNativeItemSwitch = -5,
	UIDreamDestinationADayNativeItemMultiButton = -6,
	UIDreamDestinationADayNativeItemSegmented = -7,
	
	UIDreamDestinationADayNativeItemTextView = -8,
	UIDreamDestinationADayNativeItemTextField = -9,
	UIDreamDestinationADayNativeItemSearchBar = -10,
	
	UIDreamDestinationADayNativeItemPicker = -11,
	UIDreamDestinationADayNativeItemDatePicker = -12,
	
	UIDreamDestinationADayNativeItemInfoLight = -13,
	UIDreamDestinationADayNativeItemInfoDark = -14,
	
	UIDreamDestinationADayNativeItemDisclosure = -15,
	
	UIDreamDestinationADayNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all DreamDestinationADay instances of
