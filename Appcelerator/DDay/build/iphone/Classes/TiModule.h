...
/**
 The base class for all DreamDestinationADay modules
 */
...
/**
 DreamDestinationADay Platform calls this method on startup.
 */
-(void)startup;

/**
 DreamDestinationADay Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 DreamDestinationADay Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 DreamDestinationADay Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 DreamDestinationADay Platform calls this method on resume.
 @param sender The sender of the event.
 */
