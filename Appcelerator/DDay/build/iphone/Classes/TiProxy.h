...
//Rare exceptions to indicate a bug in the _dreamdestinationaday code (Eg, function that a subclass should have implemented)
...
/**
 The base class for DreamDestinationADay proxies.
 */
