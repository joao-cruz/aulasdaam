...
//@interface DreamDestinationADayObject : NSObject
//@end

@interface DreamDestinationADayObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[DreamDestinationADayObject class]])
		{
			for (NSString *key in [[(DreamDestinationADayObject*)o modules] allKeys])
			{
