...
@interface DreamDestinationADayObject : KrollCoverageObject {
#else
@interface DreamDestinationADayObject : KrollObject {
#endif
@private
...
extern NSString * DreamDestinationADay$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	DreamDestinationADayObject *_dreamdestinationaday;
    KrollObject* console;
	BOOL shutdown;
