...
/**
 Base class for all DreamDestinationADay views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the DreamDestinationADay view hierarchy (such as wrapped iOS UIViews) was touched.
