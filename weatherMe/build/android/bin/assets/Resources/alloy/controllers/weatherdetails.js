function Controller() {
    ...
    closeDetails ? $.__views.__alloyId12.addEventListener("click", closeDetails) : __defers["$.__views.__alloyId12!click!closeDetails"] = true;
    $.__views.__alloyId10.leftNavButton = $.__views.__alloyId12;
    $.__views.__alloyId14 = Ti.UI.createButton({
        title: "Share",
        id: "__alloyId14"
    });
    shareWeather ? $.__views.__alloyId14.addEventListener("click", shareWeather) : __defers["$.__views.__alloyId14!click!shareWeather"] = true;
    ...
    addtoFavourites ? $.__views.__alloyId17.addEventListener("click", addtoFavourites) : __defers["$.__views.__alloyId17!click!addtoFavourites"] = true;
    ...
    openForecast ? $.__views.__alloyId18.addEventListener("click", openForecast) : __defers["$.__views.__alloyId18!click!openForecast"] = true;
    ...
    shareWeather ? $.__views.__alloyId19.addEventListener("click", shareWeather) : __defers["$.__views.__alloyId19!click!shareWeather"] = true;
    ...
    facebook.addEventListener("login", function(e) {
        e.success ? alert("Facebook login successfull!") : alert("Problems with Facebook login!");
    });
    __defers["$.__views.__alloyId12!click!closeDetails"] && $.__views.__alloyId12.addEventListener("click", closeDetails);
    __defers["$.__views.__alloyId14!click!shareWeather"] && $.__views.__alloyId14.addEventListener("click", shareWeather);
    __defers["$.__views.__alloyId17!click!addtoFavourites"] && $.__views.__alloyId17.addEventListener("click", addtoFavourites);
    __defers["$.__views.__alloyId18!click!openForecast"] && $.__views.__alloyId18.addEventListener("click", openForecast);
    __defers["$.__views.__alloyId19!click!shareWeather"] && $.__views.__alloyId19.addEventListener("click", shareWeather);
    _.extend($, exports);
}
