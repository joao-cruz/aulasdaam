function Controller() {
    ...
    closeDetails ? $.__views.__alloyId21.addEventListener("click", closeDetails) : __defers["$.__views.__alloyId21!click!closeDetails"] = true;
    $.__views.__alloyId19.leftNavButton = $.__views.__alloyId21;
    $.__views.__alloyId23 = Ti.UI.createButton({
        title: "Share",
        id: "__alloyId23"
    });
    shareWeather ? $.__views.__alloyId23.addEventListener("click", shareWeather) : __defers["$.__views.__alloyId23!click!shareWeather"] = true;
    ...
    addtoFavourites ? $.__views.__alloyId26.addEventListener("click", addtoFavourites) : __defers["$.__views.__alloyId26!click!addtoFavourites"] = true;
    ...
    openForecast ? $.__views.__alloyId27.addEventListener("click", openForecast) : __defers["$.__views.__alloyId27!click!openForecast"] = true;
    ...
    shareWeather ? $.__views.__alloyId28.addEventListener("click", shareWeather) : __defers["$.__views.__alloyId28!click!shareWeather"] = true;
    ...
    __defers["$.__views.__alloyId21!click!closeDetails"] && $.__views.__alloyId21.addEventListener("click", closeDetails);
    __defers["$.__views.__alloyId23!click!shareWeather"] && $.__views.__alloyId23.addEventListener("click", shareWeather);
    __defers["$.__views.__alloyId26!click!addtoFavourites"] && $.__views.__alloyId26.addEventListener("click", addtoFavourites);
    __defers["$.__views.__alloyId27!click!openForecast"] && $.__views.__alloyId27.addEventListener("click", openForecast);
    __defers["$.__views.__alloyId28!click!shareWeather"] && $.__views.__alloyId28.addEventListener("click", shareWeather);
    _.extend($, exports);
}
