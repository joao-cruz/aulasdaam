...
// in simulator we redefine to format for weatherMe Developer console
...
{\
	NSString * exceptionName = [@"org.weatherme." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.weatherme";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIweatherMeNativeItemNone = -1, 
	UIweatherMeNativeItemSpinner = -2,
	UIweatherMeNativeItemProgressBar = -3,
	
	UIweatherMeNativeItemSlider = -4,
	UIweatherMeNativeItemSwitch = -5,
	UIweatherMeNativeItemMultiButton = -6,
	UIweatherMeNativeItemSegmented = -7,
	
	UIweatherMeNativeItemTextView = -8,
	UIweatherMeNativeItemTextField = -9,
	UIweatherMeNativeItemSearchBar = -10,
	
	UIweatherMeNativeItemPicker = -11,
	UIweatherMeNativeItemDatePicker = -12,
	
	UIweatherMeNativeItemInfoLight = -13,
	UIweatherMeNativeItemInfoDark = -14,
	
	UIweatherMeNativeItemDisclosure = -15,
	
	UIweatherMeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all weatherMe instances of
