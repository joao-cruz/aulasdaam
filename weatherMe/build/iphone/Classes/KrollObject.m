...
//@interface weatherMeObject : NSObject
//@end

@interface weatherMeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[weatherMeObject class]])
		{
			for (NSString *key in [[(weatherMeObject*)o modules] allKeys])
			{
