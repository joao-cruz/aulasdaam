...
/**
 Base class for all weatherMe views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the weatherMe view hierarchy (such as wrapped iOS UIViews) was touched.
