...
@interface weatherMeObject : KrollCoverageObject {
#else
@interface weatherMeObject : KrollObject {
#endif
@private
...
extern NSString * weatherMe$ModuleRequireFormat;
