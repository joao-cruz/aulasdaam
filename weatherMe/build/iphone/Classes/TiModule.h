...
/**
 The base class for all weatherMe modules
 */
...
/**
 weatherMe Platform calls this method on startup.
 */
-(void)startup;

/**
 weatherMe Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 weatherMe Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 weatherMe Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 weatherMe Platform calls this method on resume.
 @param sender The sender of the event.
 */
