function Controller() {
    ...
    closeFavourites ? $.__views.__alloyId2.addEventListener("click", closeFavourites) : __defers["$.__views.__alloyId2!click!closeFavourites"] = true;
    ...
    __defers["$.__views.__alloyId2!click!closeFavourites"] && $.__views.__alloyId2.addEventListener("click", closeFavourites);
    _.extend($, exports);
}
