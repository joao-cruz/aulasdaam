function Controller() {
    ...
    closeForecast ? $.__views.__alloyId31.addEventListener("click", closeForecast) : __defers["$.__views.__alloyId31!click!closeForecast"] = true;
    ...
    __defers["$.__views.__alloyId31!click!closeForecast"] && $.__views.__alloyId31.addEventListener("click", closeForecast);
    _.extend($, exports);
}
