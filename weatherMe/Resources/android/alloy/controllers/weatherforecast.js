function Controller() {
    ...
    closeForecast ? $.__views.__alloyId22.addEventListener("click", closeForecast) : __defers["$.__views.__alloyId22!click!closeForecast"] = true;
    ...
    __defers["$.__views.__alloyId22!click!closeForecast"] && $.__views.__alloyId22.addEventListener("click", closeForecast);
    _.extend($, exports);
}
